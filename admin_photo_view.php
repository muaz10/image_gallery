    ...
    <body>
        ...
        ?>
					...
					<div class="row center" style="margin-right:0px">
                        ...
                        <a class="SerButton waves-effect lighten-1" href="delete_permission.php?id=<?php echo $picid ?>&category=<?php echo $category ?>">Delete Image</a>
                        <a class="SerButton waves-effect lighten-1" href="#?id=<?php echo $picid ?>">Edit Details</a>
